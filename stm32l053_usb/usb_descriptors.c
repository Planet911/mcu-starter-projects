...
const alignas(4) usb_configuration_hierarchy_t usb_configuration_hierarchy =
{
  ...
  .bulk_interface =
  {
    ...
    .bInterfaceSubClass  = 0,
    .bInterfaceProtocol  = 0,
    .iInterface          = USB_STR_STM32_WINUSB,
  },
...
{
  [USB_STR_MANUFACTURER]  = "Demo Device Manuftr.",
#ifdef USB_CONFIG_ENABLE_VCP
  [USB_STR_PRODUCT]       = "Composite Demo Device A",
#else
  [USB_STR_PRODUCT]       = "Composite Demo Device B",
#endif
  [USB_STR_SERIAL_NUMBER] = usb_serial_number,
  [USB_STR_STM32_HID]  = "STM32 HID Demo",
  [USB_STR_STM32_WINUSB]  = "STM32 WINUSB Demo",
#ifdef USB_CONFIG_ENABLE_VCP
  [USB_STR_COM_PORT]      = "STM32 VCP Demo",
#endif
};
