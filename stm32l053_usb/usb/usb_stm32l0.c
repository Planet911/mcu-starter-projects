...
void usb_hw_init(void)
{
  ...
  // Enable HSI48 oscillator for USB peripheral
  // HSI48 requires VREFINT and its buffer with 48 MHz RC to be enabled
  ...
  RCC->CCIPR |= RCC_CCIPR_HSI48SEL; // USB clock source HSI48
